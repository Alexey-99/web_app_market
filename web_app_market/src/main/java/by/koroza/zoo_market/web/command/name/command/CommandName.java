...
import static by.koroza.zoo_market.web.command.CommandType.ADMIN_PAGE_SHOW_MORE_DETAILS_ABOUT_PRODUCT_FEEDS_AND_OTHER;
import static by.koroza.zoo_market.web.command.CommandType.ADMIN_PAGE_SHOW_MORE_DETAILS_ABOUT_PRODUCT_PET;
...
import static by.koroza.zoo_market.web.command.CommandType.SHOW_REGISTRATION_FORN_VALDATED;
...
public final class CommandName {
	...
	public static final String COMMAND_VERIFICATION_REGISTRATION_INFORMATION = VERIFICATION_REGISTRATION_INFORMATION
			.toString().toLowerCase();
	public static final String COMMAND_SHOW_REGISTRATION_FORN_VALDATED = SHOW_REGISTRATION_FORN_VALDATED.toString()
			.toLowerCase();
...
//	 SHOW_MORE_DETAILS_ABOUT_PRODUCT
