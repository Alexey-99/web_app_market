package by.koroza.zoo_market.service.sorting.product.impl.comparator.map.impl.product.other.description;
...
/**
 * The Class SortProductsByProductDescriptionDescendingComparatorImpl.
 */
public class SortProductsByProductDescriptionDescendingComparatorImpl implements SortComparatorMap {
	...
	public int compare(Entry<? extends AbstractProduct, Long> o1, Entry<? extends AbstractProduct, Long> o2) {
		...
		return productDescriptionSecond.compareTo(productDescriptionFirst);
	}
}