package by.koroza.zoo_market.service.sorting.product.impl.comparator.map.impl.product.pet.birthdate;
...
/**
 * The Class SortProductsByProductPetBirthDateDescendingComparatorImpl.
 */
public class SortProductsByProductPetBirthDateDescendingComparatorImpl implements SortComparatorMap {
	...
	public int compare(Entry<? extends AbstractProduct, Long> o1, Entry<? extends AbstractProduct, Long> o2) {
		...
		String productPetBirthDateSecond = o2.getKey().getClass().equals(Pet.class)
				...
				: EMPTY_LINE_NAME;
		return productPetBirthDateSecond.compareTo(productPetBirthDateFirst);
	}
}