package by.koroza.zoo_market.service.sorting.product.impl.comparator.map.impl.product.pet.breed;
...
/**
 * The Class SortProductsByProductPetBreedAscendingComparatorImpl.
 */
public class SortProductsByProductPetBreedAscendingComparatorImpl implements SortComparatorMap {
	...
	public int compare(Entry<? extends AbstractProduct, Long> o1, Entry<? extends AbstractProduct, Long> o2) {
		...
		String productPetBreedSecond = o2.getKey().getClass().equals(Pet.class) ? ((Pet) o2.getKey()).getBreed()
				: EMPTY_LINE_NAME;
		return productPetBreedFirst.compareTo(productPetBreedSecond);
	}
}