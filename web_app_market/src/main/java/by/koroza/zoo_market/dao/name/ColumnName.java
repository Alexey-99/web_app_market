...
public final class ColumnName {
	...
	public static final String IDENTIFIER_COUNT_ROWS_OF_ORDER_PRODUCTS_PRODUCT_FEEDS_AND_OTHER_ID = IDENTIFIER_COUNT_ROWS
			+ "(" + ORDER_PRODUCTS_PRODUCT_FEEDS_AND_OTHER_ID + ")";
