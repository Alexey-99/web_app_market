							...
							<table class="table table-striped table-hover">
								<thead class="">
									<tr class="align-middle">
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
										...
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
												key="admin_page.all_products.col.brand" /></td>
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
												key="admin_page.all_products.col.description" /></td>
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
										...
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
												key="admin_page.all_products.col.number_of_units_in_available" /></td>
										<td class="text-center border-0 text-lowercase" scope="col"><fmt:message
...
<path
										...
										<th class="text-center text-lowercase" scope="row">o-${informator.getProduct().getId()}</th>
										<td class="text-center text-lowercase">${informator.getProduct().getProductType()}
										</td>
										<td class="text-center">${informator.getProduct().getBrand()}</td>
										<td class="">${informator.getProduct().getDescriptions()}</td>
										<td class="text-lowercase">
											${informator.getProduct().getPetTypes().toString().substring(1, informator.getProduct().getPetTypes().toString().length() - 1)}
										</td>
										<td class="">
                      ...
                      <path
									...
									<div
										...
										<div
											class="position-relative w-100 d-flex flex-column image_product_id_inner image_product_id_p-${informator.getProduct().getId()}_inner"
