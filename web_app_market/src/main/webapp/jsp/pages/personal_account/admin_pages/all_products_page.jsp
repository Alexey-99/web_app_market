												...
												<div class="change_product_form_body h-100">
													<form class="change_product_form_body" method="post"
														...
														<div
															...
															<div class="">
																<c:if
																	test="${pet.getKey().getImageFile() == null || pet.getKey().getImageFile().getName() == null || pet.getKey().getImageFile().getBytes() == null}">Для данного товара нет фото</c:if>
																<c:if
																	test="${pet.getKey().getImageFile() != null && pet.getKey().getImageFile().getName() != null && pet.getKey().getImageFile().getBytes() != null}">Вы выбрали
														файл: ${response.getOutputStream().write(pet.getKey().getImageFile().getBytes()) }</c:if>
															</div>
														</div>
														...
														<div
															...
															<div class="">
																<c:if
																	...
																	Вы выбрали
														файл: <img class="" src="" alt="">
																</c:if>

																<c:if
																	test="${product.getKey().getImageFile() == null || product.getKey().getImageFile().getName() == null || product.getKey().getImageFile().getBytes() == null}">
																	Для данного товара нет фото
																</c:if>
															</div>
														</div>
												</div>
