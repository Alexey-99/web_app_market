...
<path
												...
												<td class="edit_product_td"
													onclick="showChangeProductForm('p-${product.getKey().getId()}')">
...
<path
											...
											<div
												class="position-fixed d-none d-flex justify-content-center align-items-center top-0 end-0 right-0 w-100 h-100 change_product_form change_product_form_p-${product.getKey().getId()}">
												<div
													class="position-relative w-100 d-flex flex-column change_product_form_inner change_product_form_p-${product.getKey().getId()}_inner">
													<div class="image_product_id_top">
														<div class="close_btn"
															onclick="closedChangeProductForm('p-${product.getKey().getId()}')">
															<svg xmlns="http://www.w3.org/2000/svg"
																viewBox="0 0 24 24" width="25px" height="25px">
                          <path
																	d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z" />
														...
														<form class="change_product_form_body" method="post"
															...
															<div class="form-floating mb-3">
																<input type="text" class="form-control"
																	...
																	value="${product.getKey().getSpecie()}"
															...
															<div class="form-floating mb-3">
																<input type="date" class="form-control"
																	...
																	value="${product.getKey().getBirthDate()}"
