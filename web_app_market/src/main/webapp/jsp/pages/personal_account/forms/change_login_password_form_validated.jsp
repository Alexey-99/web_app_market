...
<!-- changing_login_and_password_input_exception_type_and_message = AttributeName.ATTRIBUTE_CHANGING_LOGIN_AND_PASSWORD_INPUT_EXCEPTION_TYPE_AND_MASSAGE -->
</head>
<body>
	...
	<path
								...
								<c:if
									test="${changing_login_and_password_input_exception_type_and_message.isEmpty()}">
									<form class=" " action="Controller">
                        ...
                        <path
								...
								<c:if
									test="${!changing_login_and_password_input_exception_type_and_message.isEmpty()}">
									<c:if
										test="${changing_login_and_password_input_exception_type_and_message.containsKey(ChangeLoginAndPasswordCommand.TYPY_INPUT_EXCEPTION_LOGIN)}">
										<div class="form-floating mb-3">
											<input type="text" class="form-control is-invalid"
												id="floatingInputLogin"
												name="${InputName.CHANGING_LOGIN_AND_PASSWORD_INPUT_USER_LOGIN}"
												value="${user.getLogin()}" placeholder="Robert_99" />
											<div class="invalid-feedback">${changing_login_and_password_input_exception_type_and_message.get(ChangeLoginAndPasswordCommand.TYPY_INPUT_EXCEPTION_LOGIN)}</div>
