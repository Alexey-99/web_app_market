...
<body>
		...
		<div class="container">
			<div class="row">
				<c:if test="${user != null}">
					...
					<div class="col-12">
						<div
							class="position-fixed d-none justify-content-center align-items-center top-0 end-0 right-0 w-100 h-100 general_infomation_form">
							<div
	...
	<path
					...
					<div class="col-12">
						<div
							class="position-fixed d-none justify-content-center align-items-center top-0 end-0 right-0 w-100 h-100 login_password_form">
							<div
								class="position-relative w-100 d-flex flex-column login_password_form_inner">
								<div class="login_password_form_top">
									<div class="close_btn" onclick="closeLoginPasswordForm()">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
											width="25px" height="25px">
	<path
												d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z" /></svg>
