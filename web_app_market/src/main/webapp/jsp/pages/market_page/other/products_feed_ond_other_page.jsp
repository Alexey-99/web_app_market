														...
														<div class="accordion accordion_form"
															...
															<c:if
																...
																<div class="accordion-item">
																	...
																	<div id="collapse_FilterName.CHOOSE_VALUE_DISCOUNT_RUS"
																		class="accordion-collapse collapse ">
																		<div class="accordion-body">
																			<c:forEach
										...
										<div class="card-img-top card_img"
											...
											<c:if test="${product_item.getImagePath() != null}">
												<img class="w-100 h-100"
													src="${pageContext.request.contextPath}/showImageServlet?${ParameterName.PARAMETER_IMAGE_FILE_PATH}=${product_item.getImagePath()}"
													alt="" />
											</c:if>
											<c:if test="${product_item.getImagePath() == null}">
