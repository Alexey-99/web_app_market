								...
								<div class="col card_product">
									<div class="card h-100 card_product_inner">
										<div class="card-img-top card_img"
											...
											<c:if
												test="${product_item.getImageFile() != null && product_item.getImageFile().getName() != null && product_item.getImageFile().getBytes() != null}">
												<img class=""
													src='<c:url value="${PagePathName.STORAGE_IMAGES_FOLDER_AND_SEPORATOR_PATH.concat(product_item.getImageFile().getName())}"/>'
