		...
		<div class="container" style="max-width: 1500px">
			<c:if test="${user != null}">
				<div class="row">
					<div class="col-12">
						<div
							class="d-flex justify-content-center align-items-center top-0 end-0 right-0 w-100 h-auto position-absolute add_product_form">
							<div
								...
								<div class="add_other_product_form d-none">
									<form class="add_other_product_form_body" method="post"
										...
										<div
											...
											<input type="file"
												class="form-control add_other_product_form_body_input_img"
										...
										<div class="form-floating mb-3">
											...
											<label class="text-lowercase" for="floatingInputBrand">
												<fmt:message
