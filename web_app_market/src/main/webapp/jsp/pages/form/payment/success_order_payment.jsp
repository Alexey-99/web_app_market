				...
				<div
					...
					<div
						...
						<div
							...
							<h1 class="text-uppercase success_payment_form_title">Заказ
								оплачен</h1>
							<h6 class="text-center success_payment_form_description">
								Подробности заказа высланы на электронную почту
								"${user.getEmail()}"</h6>
							<div
